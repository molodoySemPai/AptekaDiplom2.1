...
namespace AptekaDiplom22.Migrations
{
    ...
    public partial class SeedExtendedData : Migration
    {
        ...
        {
            // Обновление часов работы существующих аптек
            ...
            // Описания для существующих товаров
            migrationBuilder.UpdateData(
                table: "Products",
                keyColumn: "Id",
                keyValue: 1,
            ...
            // Остатки для новых товаров и аптеки
            migrationBuilder.InsertData(
                table: "Stocks",
            ...
            // Учётная запись администратора: admin@apteka.ru / Admin123!
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FullName", "Phone", "PasswordHash", "Role" },
                values: new object[] { 1, "admin@apteka.ru", "Администратор", "+79990000000", "$2b$11$sBfIwTPNEtRFB3gB9W.Wu.8znM7kM3EAiBprLYBxO22lsFbRknuOq", "Admin" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 12);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 11);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 10);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 9);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 8);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 7);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 6);
            migrationBuilder.DeleteData(table: "Stocks", keyColumn: "Id", keyValue: 5);
            ...
            migrationBuilder.DeleteData(table: "Pharmacies", keyColumn: "Id", keyValue: 3);
